...
class InprocClient(EngineCoreClient):
    ...
    def set_pp_config(
        ...
        self.engine_core.set_pp_config(pp_layer_config, alternative_configs, migration_steps, migration_mode, allow_resize, weight_chunk_size_mb)
